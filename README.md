...
3. Method Update Data
   Method updateData() digunakan untuk mengubah data merchandise berdasarkan ID. Jika ID ditemukan, pengguna dapat mengganti nama, harga, dan stok merchandise dengan data baru. Pada Posttest 2 ini perubahan data merchandise tidak dilakukan langsung ke variabel, tapi menggunakan method settter karena atributnya sudah dibuat menjadi private.
